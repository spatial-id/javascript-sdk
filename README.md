...
2. **タイルハッシュ形式**
    * [Z曲線](https://ja.wikipedia.org/wiki/Z%E9%9A%8E%E6%95%B0%E6%9B%B2%E7%B7%9A)や[ヒルベルト曲線](https://ja.wikipedia.org/wiki/%E3%83%92%E3%83%AB%E3%83%99%E3%83%AB%E3%83%88%E6%9B%B2%E7%B7%9A)で利用できます。
    * 空間IDは再帰的に計算でき、ズームレベル1から指定のズームレベルまで、各ズームレベルでの相対的な位置（北西下、北東下、南西下、南東下、上などの8方向）を1文字ずつ追加して、グローバルな位置を特定します。
    * ある空間IDが他の空間IDに含まれているかどうかは、文字列の**前方一致**で判定できます。
